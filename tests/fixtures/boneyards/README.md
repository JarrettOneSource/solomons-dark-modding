...
movement circles, and leaves ordinary custom boneyards untouched.
...
movement circles, renders without gravestones, trees, fences, gates, or
buildings, supports deterministic target placement, and synchronizes between
the host and clients.
