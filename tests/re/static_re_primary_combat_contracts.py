...
def test_bot_mana_spend_is_stock_owned_through_native_gate_patch() -> str:
    ...
    required_tokens = {
        ...
        "fireball damage gate branch layout": "fireball_hit_damage_projectile_group_gate_branch=0x005E5196",
        ...
        "fireball damage gate patch name": "fireball_hit_damage_projectile_group_gate",
        ...
        "fireball damage gate patch binding": "kFireballHitDamageProjectileGroupGateBranch",
