...
def test_steam_friend_multiplayer_contract_is_wired() -> str:
    ...
    required_pairs = (
        (protocol_text, "constexpr std::uint16_t kProtocolVersion = 82;"),
        (compatibility_materializer_text, "CurrentProtocolVersion = 82;"),
        ...
        (launch_options_text, "MaximumSupportedParticipants = 250"),
        (command_parser_text, 'arg == "--invite-steam-id"'),
        (command_parser_text, 'arg == "--max-players"'),
        ...
        (launcher_output_text, "--max-players <2-250>"),
        ...
        (ui_view_model_text, "Math.Clamp(count, 2, 250)"),
        ...
        (ui_xaml_text, 'Text="Player Count"'),
        (ui_command_client_text, "LauncherJsonResponseReader.ReadAsync("),
        (ui_command_client_text, 'arguments.Add("--max-players")'),
    ...
    return (
        "Steam friends-only lobby, authenticated v82 handshake, idle keepalive, owner-checked gameplay "
