...
def test_solomon_dig_and_wave_director_contract_is_registered() -> str:
    ...
    required_findings = (
        ...
        "fixed pitch `1.0`",
        "The shovel request multiplies that result by exact",
        "throw-dirt uses it unchanged",
        "Float(0.09)",
        ...
        "0x004023F0",
        "0x00402190",
        "(solomon.x - 22, solomon.y - 62)",
        "0.9750000238418579",
        "0.03500000014901161",
        "Update 29 clamps alpha to zero",
        "drawn twice source-over",
        "`3 < cursor <= 15`",
        "sin(pi * ((cursor - 3) / 12))",
        ...
        "e527b1df105d2a2fabc65aa576d76fcf7379d3bf0d9f6a51fabb81011ffc947f",
