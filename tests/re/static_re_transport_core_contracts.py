...
def test_all_dead_dispatches_native_game_over_once_per_participant() -> str:
    ...
    assert "sizeof(StatePacket) == 657" in protocol_text
    assert "sizeof(ParticipantFramePacket) == 374" in protocol_text
...
def test_all_stock_potion_subtypes_replicate_as_native_pickups() -> str:
    ...
    required_pairs = (
        ...
        (reconciliation_text, "IsSupportedReplicatedPotionSubtype"),
        (
            inventory_credit_text,
...
def test_local_multiplayer_udp_transport_is_wired() -> str:
    ...
    required_pairs = (
        ...
        (protocol_text, "static_assert(sizeof(StatePacket) == 657"),
        ...
        (protocol_text, "static_assert(sizeof(WorldActorSnapshotPacketState) == 400"),
        ...
        (protocol_text, "static_assert(sizeof(LootPickupResultPacket) == 172"),
        ...
        (
            replicated_loot_reconciliation_text,
        ...
        (participant_collision_text, "peer mirror is packet-owned"),
        (participant_collision_text, "left.actively_moving"),
        (participant_collision_text, "right.actively_moving"),
        ...
        (script_text, '$hostLaunchPreset = "pair_manual"'),
        (script_text, '$clientLaunchPreset = "pair_manual"'),
        ...
        (script_text, "[switch]$QuickStart"),
        (script_text, "SDMOD_MULTIPLAYER_QUICK_START"),
