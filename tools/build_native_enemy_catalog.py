...
ENEMY_SPECS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "behavior": [
            ...
            "The stock UI/config strings expose primary index 3 FAUST JET and secondary index 3 THING OF ICE, but the recovered event dispatcher has no corresponding branch; this remains a live-validation item rather than an invented behavior.",
        ],
    ...
    },
    {
        ...
        "behavior": [
            ...
            "A randomized countdown selected by the IMP FREQUENCY enum creates an ejected airborne Imp, copies portal team and primary damage, then resets the countdown.",
        ],
