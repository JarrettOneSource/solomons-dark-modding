...
CHECKS = (
    ("protocol version", "SolomonDarkModLoader/include/multiplayer_runtime_protocol.h", "kProtocolVersion = 54"),
    ...
    ("native inventory credit queue", "SolomonDarkModLoader/src/mod_loader_gameplay/native_inventory_reconciliation.inl", "QueueNativePotionInventoryCreditInternal"),
    ("native inventory credit apply", "SolomonDarkModLoader/src/mod_loader_gameplay/native_inventory_reconciliation.inl", "ExecuteNativePotionInventoryCreditNow"),
    ("native inventory post-apply verification", "SolomonDarkModLoader/src/mod_loader_gameplay/native_inventory_reconciliation.inl", "expected_stack_after"),
    ("native inventory convergence", "SolomonDarkModLoader/src/multiplayer_local_transport/public_cast_loot_api.inl", "MarkLocalInventoryNativeConverged"),
    ("native inventory result queueing", "SolomonDarkModLoader/src/multiplayer_local_transport/loot_pickup_authority.inl", "QueueNativePotionInventoryCredit"),
    ("native inventory gameplay pump", "SolomonDarkModLoader/src/mod_loader_gameplay/dispatch_and_hooks_pump_loop.inl", "ExecuteNativePotionInventoryCreditNow"),
