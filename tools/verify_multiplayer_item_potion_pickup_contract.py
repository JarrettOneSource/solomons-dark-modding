...
CHECKS = (
    ("protocol version", "SolomonDarkModLoader/include/multiplayer_runtime_protocol.h", "kProtocolVersion = 27"),
    ...
    ("held item reader", "SolomonDarkModLoader/src/multiplayer_local_transport.cpp", "TryReadItemDropHeldItemMetadata"),
    ("item snapshot", "SolomonDarkModLoader/src/multiplayer_local_transport.cpp", "TryPopulateItemLootDropSnapshot"),
    ("item deactivate", "SolomonDarkModLoader/src/multiplayer_local_transport.cpp", "TryDeactivateHostItemLootDrop"),
    ("item payload", "SolomonDarkModLoader/src/multiplayer_local_transport.cpp", "TryBuildAcceptedItemLootPickupPayload"),
    ("ledger mutation", "SolomonDarkModLoader/src/multiplayer_local_transport.cpp", "ApplyOwnedInventoryLootItem"),
