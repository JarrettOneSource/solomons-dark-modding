...
emit("magic_shield_absorb_remaining", snapshot.magic_shield_absorb_remaining or 0)
emit("magic_shield_absorb_capacity", snapshot.magic_shield_absorb_capacity or 0)
emit("magic_shield_explosion_fraction", snapshot.magic_shield_explosion_fraction or 0)
emit("magic_shield_hit_flash", snapshot.magic_shield_hit_flash or 0)
