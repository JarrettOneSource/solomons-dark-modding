...
emit_num("peer.magic_shield_absorb_remaining", peer and peer.magic_shield_absorb_remaining or 0)
emit_num("peer.magic_shield_absorb_capacity", peer and peer.magic_shield_absorb_capacity or 0)
emit_num("peer.magic_shield_explosion_fraction", peer and peer.magic_shield_explosion_fraction or 0)
emit_num("peer.magic_shield_hit_flash", peer and peer.magic_shield_hit_flash or 0)
...
if actor ~= 0 then
  ...
  local shield_remaining = off("actor_magic_shield_absorb_remaining")
  local shield_capacity = off("actor_magic_shield_absorb_capacity")
  local shield_explosion = off("actor_magic_shield_explosion_fraction")
  local shield_hit_flash = off("actor_magic_shield_hit_flash")
  ...
  emit_num("actor.magic_shield_absorb_remaining", sd.debug.read_float(actor + shield_remaining) or 0)
  emit_num("actor.magic_shield_absorb_capacity", sd.debug.read_float(actor + shield_capacity) or 0)
  emit_num("actor.magic_shield_explosion_fraction", sd.debug.read_float(actor + shield_explosion) or 0)
  emit_num("actor.magic_shield_hit_flash", sd.debug.read_float(actor + shield_hit_flash) or 0)
else
