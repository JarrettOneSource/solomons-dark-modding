...
constexpr std::array<NativePrimaryBuildMapping, 20> kNativePrimaryBuildMappings = {{
    {1000, 1000, 0x08, 0x10},
    {1001, 1001, 0x08, 0x20},
    {1002, 1002, 0x08, 0x18},
    {1003, 1003, 0x10, 0x18},
...
const NativePrimaryBuildMapping* FindNativePrimaryBuildMapping(int native_build_id) {
