...
bool ParseDebugUiOverlayConfig(
    ...
    static constexpr AddressField kRequiredAddressFields[] = {
        ...
        {"ui_render_context_color_helper", &DebugUiOverlayConfig::ui_render_context_color_helper},
        ...
        {"dark_cloud_browser_tab_render_helper", &DebugUiOverlayConfig::dark_cloud_browser_tab_render_helper},
        {"dark_cloud_browser_text_render_wrapper_helper", &DebugUiOverlayConfig::dark_cloud_browser_text_render_wrapper_helper},
        {"dark_cloud_browser_asset_global", &DebugUiOverlayConfig::dark_cloud_browser_asset_global},
        {"dark_cloud_browser_text_object_global", &DebugUiOverlayConfig::dark_cloud_browser_text_object_global},
    ...
    static constexpr SizeField kRequiredSizeFields[] = {
        ...
        {"dark_cloud_browser_tab_asset_offset", &DebugUiOverlayConfig::dark_cloud_browser_tab_asset_offset},
        {"dark_cloud_browser_text_object_offset", &DebugUiOverlayConfig::dark_cloud_browser_text_object_offset},
        ...
        {"dark_cloud_browser_entry_count_offset", &DebugUiOverlayConfig::dark_cloud_browser_entry_count_offset},
