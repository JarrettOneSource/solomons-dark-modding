bool InitializeGameplayKeyboardInjection(std::string* error_message) {
    ...
    g_gameplay_keyboard_injection.mouse_right_edge_serial.store(0, std::memory_order_release);
    ...
    ResetLocalPlayerTickOwnershipState();
    {
        ...
        g_gameplay_keyboard_injection.pending_native_experience_gain_probes.clear();
