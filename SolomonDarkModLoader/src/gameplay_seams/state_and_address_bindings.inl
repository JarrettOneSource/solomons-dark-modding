...
const AddressBinding* GetAddressBindings(std::size_t* count) {
    static const AddressBinding bindings[] = {
        ...
        SDMOD_ADDR("gameplay.hooks", "player_actor_apply_mana_delta", kPlayerActorApplyManaDelta),
        ...
        SDMOD_ADDR("gameplay.hooks", "movement_collision_iterate_primary_recover", kMovementCollisionIteratePrimaryRecover),
        ...
        SDMOD_ADDR("gameplay.hooks", "actor_world_attach", kActorWorldAttach),
        ...
        SDMOD_ADDR("gameplay.hooks", "actor_world_lookup_object_by_handle", kActorWorldLookupObjectByHandle),
        ...
        SDMOD_ADDR("gameplay.hooks", "skills_wizard_get_primary_color", kSkillsWizardGetPrimaryColor),
        ...
        SDMOD_ADDR("gameplay.hooks", "orb_reward_initialize", kOrbRewardInitialize),
        SDMOD_ADDR("gameplay.hooks", "orb_pickup", kOrbPickup),
        ...
        SDMOD_ADDR("gameplay.cast_gate_patches", "spell_cast_008_slot_gate_branch", kSpellCast008SlotGateBranch),
        SDMOD_ADDR("gameplay.cast_gate_patches", "spell_cast_008_projectile_slot_gate_branch", kSpellCast008ProjectileSlotGateBranch),
        SDMOD_ADDR("gameplay.cast_gate_patches", "spell_cast_010_slot_gate_branch", kSpellCast010SlotGateBranch),
        ...
        SDMOD_ADDR("gameplay.globals", "earth_boulder_release_damage_cap_scale", kEarthBoulderReleaseDamageCapScaleGlobal),
