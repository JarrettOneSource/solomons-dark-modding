...
// never reaches the reusable labeled-control render helpers. This signature is
// pinned by the read-only Ghidra scalar/toggle call sites: one native
// String-by-value plus a value pointer.
...
constexpr std::size_t kControlSchemePickerRenderHookPatchSize = 5;
...
constexpr ULONGLONG kTrackedControlSchemePickerMaximumIdleMs = 250;
...
struct DebugUiOverlayState {
    ...
    bool first_control_scheme_picker_render_logged = false;
    ...
    X86Hook control_scheme_picker_render_hook;
    ...
    TrackedSurfaceRenderState control_scheme_picker_render;
