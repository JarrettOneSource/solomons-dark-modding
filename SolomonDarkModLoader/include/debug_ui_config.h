...
struct DebugUiOverlayConfig {
    ...
    size_t string_object_text_pointer_offset = 0;
    size_t string_object_length_offset = 0;
    size_t ui_render_context_base_x_offset = 0;
    size_t ui_render_context_base_y_offset = 0;
    ...
    size_t ui_rollout_parent_offset = 0;
    size_t ui_owner_control_action_vtable_byte_offset = 0;
    ...
    size_t settings_control_enabled_byte_offset = 0;
    size_t settings_control_dispatch_offset = 0;
    size_t settings_control_callback_owner_offset = 0;
    ...
    size_t settings_controls_guard_pointer_offset = 0;
    size_t settings_controls_expected_guard_offset = 0;
    size_t control_noarg_owner_offset = 0;
    size_t control_noarg_context_offset = 0;
    size_t control_noarg_callback_offset = 0;
