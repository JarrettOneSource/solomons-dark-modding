...
| `74` | Ether Drain | Creates `EtherDrain (0x807)`, writes `mDamage / 100` as the radius-20 contact scalar, resolves the aimed origin through the world, and registers its 100-active-tick radius-512 pressure field. Candidate identities refresh through the class-owned arrays; nonempty Gold/Sack containers are protected from center capture. |
