...
- Earth boulder release/damage was deepened with Ghidra and live evidence:
  ...
  - `0x004621B0`: the object `+0x58` vfunc reads the world's active query
    ...
    `clamp(base_damage * 0.5 * size^2)` for the live target after the active
    Boulder reaches the recovered native minimum release charge, or uses the
