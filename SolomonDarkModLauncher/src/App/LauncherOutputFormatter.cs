...
internal static class LauncherOutputFormatter
{
    public static string FormatHelp()
    {
        ...
        [
            ...
            "  --steam-appid <id>      Override steam_appid.txt. Defaults: 3362180 single-player; Spacewar 480 multiplayer.",
            ...
            "  --lobby-id <id>         Join a specific Steam lobby; otherwise start Steam invite join mode.",
